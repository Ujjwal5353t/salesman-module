...
import { Shield, Store, ChevronRight, Sparkles } from "lucide-react";
  ...
  return (
    <div className="page-container relative overflow-hidden min-h-screen flex flex-col">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-retailer/3 rounded-full blur-3xl" />
      </div>

      <div className="relative z-10 w-full max-w-2xl mx-auto flex-1 flex flex-col justify-center">
        {/* Logo and Title Section */}
        <div className="text-center mb-12 animate-fade-in">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/20 mb-6 animate-glow">
